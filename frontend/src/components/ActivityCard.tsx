  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.actionRow}>
        <TouchableOpacity
          style={[styles.joinButton, activity.joined && styles.joinedButton]}
        ...
        >
          ...
          />
          <Text style={styles.joinButtonText}>{activity.joined ? 'Open Chat' : 'Join Activity'}</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  topBadges: { position: 'absolute', top: 10, left: 10, right: 10, flexDirection: 'row', justifyContent: 'space-between' },
